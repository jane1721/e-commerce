...
| GET    | `/api/users/{userId}/coupons` | 보유 쿠폰 조회    | -                           | [<br/> {<br/> "code": "DISCOUNT-10",<br/> "discount_percent": 10,<br/> "expiryDate": "2025-03-31T23:59:59",<br/> "isUsed": false<br/> },<br/> {<br/> "code": "DISCOUNT-20",<br/> "discount_percent": 20,<br/> "expiryDate": "2025-01-31T23:59:59",<br/> "isUsed": false<br/> }<br/> ] |
...
| GET    | `/api/users/{userId}/carts` | 장바구니 조회     | -                                                                   | [<br/> {<br/> "itemId": "1",<br/> "name": "Item A",<br/> "quantity": 2,<br/> "price": 5000<br/> }<br/> ] |
